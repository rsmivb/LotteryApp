...
namespace LotteryApi.Controllers
{
    ...
    public class MegaSenaController : Controller
    {
        ...
        public MegaSenaController(AppSettings settings, IWebService webService)
        {
            _settings = settings;
        ...
        public IActionResult DownloadResultsFromSource()
        {
            try
            {
                _webService.DownloadFile(_settings.Lotteries.Where(lottery => lottery.Name == "MegaSena").SingleOrDefault(),
