...
namespace LotteryApi.Controllers
{
    ...
    public class LotoManiaController : Controller
    {
        ...
        public LotoManiaController(AppSettings settings, IWebService webService)
        {
            _settings = settings;
        ...
        public IActionResult DownloadResultsFromSource()
        {
            try
            {
                _webService.DownloadFile(_settings.Lotteries.Where(lottery => lottery.Name == "LotoMania").SingleOrDefault(),
