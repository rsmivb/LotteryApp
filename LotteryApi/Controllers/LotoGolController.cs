...
namespace LotteryApi.Controllers
{
    ...
    public class LotoGolController : Controller
    {
        ...
        public LotoGolController(AppSettings settings, IWebService webService)
        {
            _settings = settings;
        ...
        public IActionResult DownloadResultsFromSource()
        {
            try
            {
                _webService.DownloadFile(_settings.Lotteries.Where(lottery => lottery.Name == "LotoGol").SingleOrDefault(),
