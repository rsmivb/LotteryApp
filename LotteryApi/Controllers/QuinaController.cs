...
namespace LotteryApi.Controllers
{
    ...
    public class QuinaController : Controller
    {
        ...
        public QuinaController(AppSettings settings, IWebService webService)
        {
            _settings = settings;
        ...
        public IActionResult DownloadResultsFromSource()
        {
            try
            {
                _webService.DownloadFile(_settings.Lotteries.Where(lottery => lottery.Name == "Quina").SingleOrDefault(),
