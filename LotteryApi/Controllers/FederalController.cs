...
namespace LotteryApi.Controllers
{
    ...
    public class FederalController : Controller
    {
        ...
        public FederalController(AppSettings settings, IWebService webService)
        {
            _settings = settings;
        ...
        public IActionResult DownloadResultsFromSource()
        {
            try
            {
                _webService.DownloadFile(_settings.Lotteries.Where(lottery => lottery.Name == "Federal").SingleOrDefault(),
