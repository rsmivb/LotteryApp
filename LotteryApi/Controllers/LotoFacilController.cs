...
namespace LotteryApi.Controllers
{
    ...
    public class LotoFacilController : Controller
    {
        ...
        public LotoFacilController(AppSettings settings, IWebService webService)
        {
            _settings = settings;
        ...
        public IActionResult DownloadResultsFromSource()
        {
            try
            {
                _webService.DownloadFile(_settings.Lotteries.Where(lottery => lottery.Name == "LotoFacil").SingleOrDefault(),
